...
# "Hola Mundo", 2, 4, "Harvys". Todos los valores tienen un TIPO. Y después del tipo las operaciones que podemos realizar con ellos.

# Para ver el tipo de valor, tenemos la función type()

print(type("Hola Mundo")) # Los textos son tipo 'string' o 'str'
print(type(2)) # Los números enteros son de tipo 'int'
print(type(3.2)) # Los número con parte decimal son 'float'
