...
# Crear un programa que muestre el valor de la llave solicitada si existe en el diccionario, y que diga que no está si la llave no está en el diccionario.
